  ...
  return (
   ...
   <div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
      ...
      >
        ...
        <div
          class="p-4 py-6 order-2 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
          <div class="my-3 text-4xl font-bold tracking-wider text-center">
            <a href="#">FelxGeeks</a>
          </div>
          <p class="mt-6 font-normal text-center text-gray-300 md:mt-0">
          With the power of FelxGeeks, you can now focus only on functionaries for your digital products, while leaving the
        UI design on us!
          </p>
