function StudyMaterial() {
  return (
    <div className="ml-[20%] w-[80%] h-[100svh] flex flex-col justify-center items-center relative bg-blue-500 p-10">
      <h1 className="text-2xl font-bold mb-4 w-full text-center absolute top-5">
        StudyMaterial
      </h1>
      <div className=" w-[60%] flex justify-center  ">
        <form className="space-y-4 w-[100%]">
          ...
          <div>
            <label className="block text-gray-700">Image/pdf</label>
            <input
              type="file"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
